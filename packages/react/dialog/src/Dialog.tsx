...
type DialogTriggerProps = PrimitiveTypes.ComponentPropsWithoutRef<typeof Primitive.button>;
...
type DialogOverlayProps = PrimitiveTypes.MergeProps<
  PrimitiveTypes.ComponentPropsWithoutRef<typeof DialogOverlayImpl>,
  {
    /**
...
type DialogOverlayImplProps = PrimitiveTypes.ComponentPropsWithoutRef<typeof Primitive.div>;
...
>;
type DialogContentProps = PrimitiveTypes.MergeProps<
  PrimitiveTypes.ComponentPropsWithoutRef<typeof DialogContentModal | typeof DialogContentNonModal>,
  {
    /**
     * Used to force mounting when more control is needed. Useful when
     * controlling animation with React animation libraries.
...
type DialogContentTypeProps = Omit<
  PrimitiveTypes.ComponentPropsWithoutRef<typeof DialogContentImpl>,
...
type DialogContentImplProps = PrimitiveTypes.MergeProps<
  Omit<PrimitiveTypes.ComponentPropsWithoutRef<typeof DismissableLayer>, 'onDismiss'>,
  {
    /**
...
type DialogTitleProps = PrimitiveTypes.ComponentPropsWithoutRef<typeof Primitive.h2>;
...
type DialogDescriptionProps = PrimitiveTypes.ComponentPropsWithoutRef<typeof Primitive.p>;
...
type DialogCloseProps = PrimitiveTypes.ComponentPropsWithoutRef<typeof Primitive.button>;
