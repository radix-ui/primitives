...
const DismissableLayer = React.forwardRef<DismissableLayerElement, DismissableLayerProps>(
  (props, forwardedRef) => {
    ...
    const getOwnerDocumentImpl = React.useCallback(() => {
    ...
    React.useEffect(() => {
      ...
      const ownerDocument = getOwnerDocument(node);
      ownerDocument.addEventListener(CONTEXT_UPDATE, handleUpdate);
      return () => ownerDocument.removeEventListener(CONTEXT_UPDATE, handleUpdate);
    }, [node]);
...
function usePointerDownOutside(
  ...
  }, [getOwnerDocument, handlePointerDownOutside]);
...
function useFocusOutside(
  ...
  }, [getOwnerDocument, handleFocusOutside]);
