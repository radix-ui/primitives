...
type DismissableLayerProps = PrimitiveTypes.ComponentPropsWithoutRef<typeof DismissableLayerImpl>;
...
type DismissableLayerImplProps = PrimitiveTypes.MergeProps<
