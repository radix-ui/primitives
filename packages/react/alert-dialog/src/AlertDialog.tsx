...
type AlertDialogProps = Omit<React.ComponentPropsWithoutRef<typeof DialogPrimitive.Root>, 'modal'>;
...
type AlertDialogCancelProps = React.ComponentPropsWithoutRef<typeof DialogPrimitive.Close>;
