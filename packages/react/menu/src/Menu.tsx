...
type MenuItemDOMProps = Omit<React.ComponentPropsWithoutRef<typeof ITEM_DEFAULT_TAG>, 'onSelect'>;
...
type MenuCheckboxItemProps = MenuItemProps & MenuCheckboxItemOwnProps;

const MenuCheckboxItem = forwardRef<typeof ITEM_DEFAULT_TAG, MenuCheckboxItemProps>(
  (props, forwardedRef) => {
    const {
      value,
      checked: checkedProp,
...
const MenuRadioGroup: React.FC<MenuRadioGroupProps> = (props) => {
...
type MenuRadioItemProps = MenuItemProps & MenuRadioItemOwnProps;

const MenuRadioItem = forwardRef<typeof ITEM_DEFAULT_TAG, MenuRadioItemProps>(
  (props, forwardedRef) => {
...
const ITEM_INDICATOR_NAME = 'Menu.ItemIndicator';
const ITEM_INDICATOR_DEFAULT_TAG = 'span';

const ItemIndicatorContext = React.createContext(false);

type MenuItemIndicatorDOMProps = React.ComponentPropsWithoutRef<typeof ITEM_INDICATOR_DEFAULT_TAG>;
type MenuItemIndicatorOwnProps = {};
type MenuItemIndicatorProps = MenuItemIndicatorDOMProps & MenuItemIndicatorOwnProps;

const MenuItemIndicator = forwardRef<typeof ITEM_INDICATOR_DEFAULT_TAG, MenuItemIndicatorProps>(
  (props, forwardedRef) => {
...
Menu.CheckboxItem.displayName = CHECKBOX_ITEM_NAME;
Menu.RadioGroup.displayName = RADIO_GROUP_NAME;
Menu.RadioItem.displayName = RADIO_ITEM_NAME;
Menu.ItemIndicator.displayName = ITEM_INDICATOR_NAME;
