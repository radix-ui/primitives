...
type AccordionProps =
  | ({ type: 'single' } & React.ComponentPropsWithoutRef<typeof AccordionSingle>)
  | ({ type: 'multiple' } & React.ComponentPropsWithoutRef<typeof AccordionMultiple>);

const Accordion = React.forwardRef<AccordionElement, AccordionProps>((props, forwardedRef) => {
  const { type, ...accordionProps } = props;

  if (type === 'single') {
    const singleProps = accordionProps as React.ComponentPropsWithoutRef<typeof AccordionSingle>;
    return <AccordionSingle {...singleProps} ref={forwardedRef} />;
  }

  if (type === 'multiple') {
    const multipleProps = accordionProps as React.ComponentPropsWithoutRef<
...
type AccordionSingleProps = MergeProps<
  React.ComponentPropsWithoutRef<typeof AccordionImpl>,
  {
    /**
...
type AccordionMultipleProps = MergeProps<
  React.ComponentPropsWithoutRef<typeof AccordionImpl>,
  {
    /**
...
type AccordionImplProps = MergeProps<
...
type AccordionItemProps = MergeProps<
  Omit<
...
type AccordionHeaderProps = React.ComponentPropsWithoutRef<typeof Primitive.h3>;
/**
...
type AccordionTriggerProps = React.ComponentPropsWithoutRef<typeof CollapsiblePrimitive.Trigger>;
...
type AccordionContentProps = React.ComponentPropsWithoutRef<typeof CollapsiblePrimitive.Content>;
/**
