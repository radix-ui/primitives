...
} from './_collapsible-components';
import StylingCSS from './_collapsible-styling-css.mdx';
  ...
  return (
    <div>
      <Collapsible isOpen={isOpen} onToggle={setIsOpen}>
        <Collapsible.Button>Greeting</Collapsible.Button>
        <Collapsible.Content id="greeting">Hello there!</Collapsible.Content>
      </Collapsible>
...
export const MyComponent = () => (
  <Collapsible>
    <div>
      <Collapsible.Button>Collapsible button</Collapsible.Button>
